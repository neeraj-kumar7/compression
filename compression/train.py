...
def train(path,epoch,verbose=False,DETRAC=False):
    ...
    print('Training using DETRAC: ', DETRAC)
    #Dataloading
    ...
    """Use this for training using GPU"""
    model_n.cuda()
    ...
    for e in range(epoch):
        ...
        torch.save(model.state_dict(), "./../models/CAE_Full_data.pwf")
        if verbose : print("Epoch : ",e+1, " - Loss : ",loss)
        print()
